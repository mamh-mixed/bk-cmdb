...
// 管控区域加IPV4
export const AREA_IPV4_IP = /(?<![a-zA-Z0-9.])(?<ip>((-1|\d+):((?:[0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])[.]){3}(?:[0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]))|((\d+):\[((?:[0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])[.]){3}(?:[0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\]))(?!\d)/g

// 管控区域加IPV6
export const AREA_IPV6_IP = /(?<![a-zA-Z0-9:])(?<ip>(-1|\d+):\[(([0-9a-fA-F]{4}:){7}[0-9a-fA-F]{4})\])(?![0-9a-fA-F:])/g
