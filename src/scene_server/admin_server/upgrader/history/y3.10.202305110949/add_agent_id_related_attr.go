...
func addDefaultHostAddressingField(ctx context.Context, db dal.RDB, conf *history.Config) error {
...
func adjustHostUniqueIndex(ctx context.Context, db dal.RDB, conf *history.Config) error {
