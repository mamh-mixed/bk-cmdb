...
func addDefaultBiz(ctx context.Context, db dal.RDB, conf *history.Config) error {
	...
	bizID, _, err := history.Upsert(ctx, db, common.BKTableNameBaseApp, defaultBiz, common.BKAppIDField,
	...
	setID, _, err := history.Upsert(ctx, db, common.BKTableNameBaseSet, defaultSet, common.BKSetIDField,
	...
	_, _, err = history.Upsert(ctx, db, common.BKTableNameBaseModule, defaultResModule, common.BKModuleIDField,
	...
	_, _, err = history.Upsert(ctx, db, common.BKTableNameBaseModule, defaultFaultModule, common.BKModuleIDField,
		[]string{"bk_supplier_account", common.BKModuleNameField, common.BKAppIDField, common.BKSetIDField,
			common.BKDefaultField}, append(filled, common.BKModuleIDField))
	if err != nil {
