...
func addObjAttrDesIsMultipleColumn(ctx context.Context, db dal.RDB, conf *history.Config) error {
...
func updateUserFieldTypeObjAttrIsMultiple(ctx context.Context, db dal.RDB, conf *history.Config) error {
