...
import (
	...
	tenantset "configcenter/src/scene_server/topo_server/service/tenant_set"
...
func (s *Service) initBusiness(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/find/resource_pool/biz",
		Handler: s.GetResourcePoolBiz})
...
func (s *Service) initService(web *restful.WebService) {
	...
	tenantset.InitTenantSet(utility, c)
